...
![Step 5: Paste Code into Apps Script Editor](./screenshots/05-paste-code.png)

6. Scroll up to the very top of the editor. Look at lines 4 to 8. You need to replace the placeholder text with your actual store details inside the single quotation marks:
...
![Step 6: Edit Configuration Parameters](./screenshots/06-edit-config.png)

7. Click the **Save** icon (the small blue floppy disk icon at the top of the editor) or press `Ctrl + S` (`Cmd + S` on Mac).
...
![Step 7: Click New Deployment](./screenshots/07-new-deployment.png)
...
![Step 10: Copy the Generated Web App URL](./screenshots/10-copy-web-app-url.png)
...
![Step 11: Click on the Triggers Menu](./screenshots/11-triggers-menu.png)
...
![Step 12: Configure On-Edit Trigger Dropdowns](./screenshots/12-configure-trigger.png)
...
![Step 13: Paste PHP Code Into Snippets Plugin](./screenshots/13-paste-php-snippet.png)

5. Scroll down to the configuration section inside the code. Look for these two lines:
...
6. Carefully make the adjustments:
    ...
    * Delete `YOUR_CUSTOM_SECRET_SECURITY_TOKEN_HERE` and paste the exact **SECRET_TOKEN** text password you created in Phase 2.
 7. Select **Run snippet everywhere** and click the blue **Save Changes and Activate** button at the bottom.

![Step 14: Save and Activate WordPress Code](./screenshots/14-activate-snippet.png)
